  ...
  return (
    <section className="py-48  flex flex-col gap-10 lg:px-20 md:px-10 px-5">
      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 gap-5">
        <div className="dark:bg-[#242a38] bg-white bg-opacity-10 rounded-lg lg:p-8 p-4 border-2 border-yellow-400 ">
        ...
        <div className="dark:bg-[#242a38] bg-white bg-opacity-10 rounded-lg border-2 border-teal-400 lg:p-8 p-4">
        ...
        <div className="dark:bg-[#242a38] bg-white bg-opacity-10 border-2 border-pink-400 rounded-lg lg:p-8 p-4">
        ...
        <div className="dark:bg-[#242a38] bg-white bg-opacity-10 border-2 border-blue-400 rounded-lg lg:p-8 p-4">
