  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast:
            "group toast group-[.toaster]:bg-white group-[.toaster]:text-black group-[.toaster]:border-none group-[.toaster]:rounded-lg group-[.toaster]:p-6 group-[.toaster]:text-xs group-[.toaster]:shadow-2xl group-[.toaster]:h-16 ",
          description:
